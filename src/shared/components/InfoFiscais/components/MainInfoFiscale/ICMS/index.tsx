                    ...
                    <Form>
                        ...
                        <Form.Group as={Col}>
                            <FloatingLabel className="mb-4" style={{ color: "black", fontSize: "14px" }} label="Tipo de Tributação">
                                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="situacao_tributaria_icms" value={impostos?.icms?.situacao_tributaria || " "}>
                                    <option>0 - Simples Nacional</option>
                                    <option>1 - Tributação Normal</option>
                        ...
                        <Form.Group as={Col} >
                            <FloatingLabel className="mb-4" style={{ color: "black", fontSize: "14px" }} label="Cenário">
                                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="cenario_icms" value={ impostos?.icms?.cenario || " " }>
                        ...
                        <Form.Group as={Col} >
                            <FloatingLabel className="mb-4" style={{ color: "black", fontSize: "14px" }} label="Tipo de Pessoa">
                                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="tipo_pessoa_icms" defaultValue={impostos?.icms?.tipo_pessoa || " " }>
                        ...
                        <FloatingLabel className="mb-4" style={{ color: "black", fontSize: "14px" }} label="Código CFOP">
                            <Form.Control onChange={handleChange} style={{ height: "48px" }} type="text" defaultValue={impostos?.icms?.codigo_cfop || " "} name="cfop_icms" />
                        </FloatingLabel>
                        ...
                        <InputGroup className="mb-3">
                            ...
                            <FloatingLabel style={{ color: "black", fontSize: "14px" }} label="Definição Imposto">
                                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="situacao_tributaria_icms" defaultValue={impostos?.icms?.situacao_tributaria || " " }>
