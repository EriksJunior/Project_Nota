          ...
          <Form>
            <Form.Group as={Col}>
              <FloatingLabel className="mb-4" style={{ fontSize: "14px" }} label="Tipo de Pessoa">
                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="tipo_pessoa_pis" defaultValue={impostos?.pis?.tipo_pessoa || " " } >
            ...
            <Form.Group as={Col} >
              <FloatingLabel className="mb-4" style={{ fontSize: "14px" }} label="Cenário">
                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="cenario_pis" defaultValue={impostos?.pis?.cenario || " " }>
            ...
            <Form.Group as={Col}>
              <FloatingLabel className="mb-4" style={{ fontSize: "14px" }} label="Situação Tributária">
                <Form.Select onChange={handleChange} style={{ color: "Grey", fontWeight: "bolder", height: "48px" }} name="situacao_tributaria_pis" defaultValue={impostos?.pis?.situacao_tributaria|| " " }>
            ...
            <InputGroup className="mb-3">
              ...
              <FloatingLabel style={{ fontSize: "14px" }} label="Aliquota">
                <Form.Control onChange={handleChange} style={{ height: "48px" }} type="text" defaultValue={impostos?.pis?.aliquota || " "} name="aliquota_pis" />
              </FloatingLabel>
            </InputGroup>
          </Form>
        </Card.Body>
